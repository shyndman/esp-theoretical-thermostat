## 1. Spec & Planning
- [x] 1.1 Update `thermostat-connectivity` spec with the new MQTT entity IDs and scenario text.
- [x] 1.2 Run `openspec validate update-entity-ids --strict` and fix any formatting issues.
