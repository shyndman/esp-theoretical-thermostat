...
- [ ] 1.2 Replace MJPEG encoder path with H.264 M2M on `/dev/video11`, configuring YUV420 input at 800x800.
...
- [ ] 2.2 Validate streaming with Frigate/Go2RTC at 800x800@8fps and record observations in `docs/manual-test-plan.md`.
